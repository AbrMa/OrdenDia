<%-- 
    Document   : BusquedaFranquiciaConsultaPlatillo
    Created on : 10/12/2015, 11:06:27 PM
    Author     : Carmen
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <form class="form-horizontal" role="form" method="post" name="BorraRest" action="BusquedaRestauranteConsultaPlatillo.jsp">
