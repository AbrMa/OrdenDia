<%-- 
    Document   : BusquedaFranquiciaConsultaRestaurante
    Created on : 10/12/2015, 09:59:02 PM
    Author     : Carmen
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <!--Formulario-->
        <div class="container">
            <center><h2>Buscar Restaurante</h2></center>
            <hr>
            <center><h3>Seleccionar Franquicia</h3></center>
            <hr>
        </div>  
        <div class="container">
            <form class="form-horizontal" role="form" method="post" name="BorraRest" action="BusquedaConsultaRestauranteFull.jsp">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                            ...
                            <%
                                ...
                                try {
                                    sql.conectar();
                                    ResultSet rsUsr = sql.consulta("call sp_ConsultaFranquiciaFull();");  
