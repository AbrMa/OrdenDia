<%-- 
    Document   : PreBajaPlatillo
    Created on : 07-dic-2015, 21:12:14
    Author     : Alejandro
--%>
    ...
    <body onload="recargas();">
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                ...
                <p class="lead">Localiza alguno de tus platillos para eliminarlo .</p>
            ...
            <div class="col-sm-5">
                ...
                <div class="panel panel-warning">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" name="BorraPlat2" action="BusquedaBajaPlatillo">
                            <div class="panel-body">
