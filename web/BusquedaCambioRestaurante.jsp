<%-- 
    Document   : BusquedaCambioRestaurante
    Created on : 07-dic-2015, 19:44:19
    Author     : Alejandro
--%>
    ...
    <body onload="recargas();">
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                ...
                <p class="lead">Localiza alguno de tus restaurantes para modificarlo .</p>
            ...
            <div class="col-sm-5">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" name="BorraRest" action="BusquedaCambioRestaurante">
                            <div class="panel-body">
