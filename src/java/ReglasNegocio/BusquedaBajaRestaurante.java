 ...
 * @author Carmen
 */
@WebServlet(name = "BusquedaBajaRestaurante", urlPatterns = {"/BusquedaBajaRestaurante"})
public class BusquedaBajaRestaurante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (nom != null) {
                ...
                try {
                    sql.conectar();
                    ResultSet rsUsr = sql.consulta("call sp_ConsultaRestaurante3('" + nom + "');");
                    ...
                    while (rsUsr.next()) {
                        ...
                        out.println("<html lang=\"en\">\n"
                                ...
                                + "        <!--Formulario-->\n"
                                + "        <div class=\"container\">\n"
                                + "            <center><h3>Eliminar Restaurante</h3></center>\n"
                                + "<h3>¿Está completamente seguro de Eliminar este Restaurante?</h3>\n"
                                + "<h4>Este proceso es Irreversible</h4>\n"
                                + "            <hr>\n"
                                + "        </div>  \n"
                                + "        <div class=\"container\">\n"
                                + "            <form class=\"form-horizontal\" role=\"form\" method=\"post\" name=\"BajaRest\" action=\"BorraRestaurante.jsp\">\n"
                                ...
                                + "<button type=\"button\" onclick=\"location.href='menuFranquicia.jsp';\" class=\"btn btn-info\">No</button>\n"
                                + "                    </div>\n"
                                + "                </div>\n"
                                + "            </form>\n"
                                + "        </div>\n"
