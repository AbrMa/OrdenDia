 ...
 * @author Alejandro
 */
@WebServlet(name = "BusquedaBajaUsuario", urlPatterns = {"/BusquedaBajaUsuario"})
public class BusquedaBajaUsuario extends HttpServlet {
                ...
                try {
                    ...
                    while (rsUsr.next()) {
                        ...
                        out.println("<html lang=\"en\">\n"
                                ...
                                + "        <div class=\"container\">\n"
                                + "         \n"
                                + "            <center><h3>¿Desea Borrar los Datos?</h3></center>\n"
                                + "            <hr>\n"
                                + "        </div>\n"
                                + "        <div class=\"container\">\n"
                                + "            <form class=\"form-horizontal\" role=\"form\" name=\"BorraUsuario\" method=\"Post\" Action=\"BorraUsuario.jsp\">\n"
                                ...
                                + "                            <option value=Cambiar"+Descripcion+">Selecciona Una Opción</option>\n"
                                ...
                                + "                        <button type=\"button\" href=\"menu.jsp\" class=\"btn btn-default\">Cancelar</button>\n"
                                + "                    </div>\n"
                                + "                </div>\n"
                                + "            </form>\n"
                                + "        </div>\n"
