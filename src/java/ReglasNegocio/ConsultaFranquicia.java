 ...
 * @author Amahury
 */
@WebServlet(name = "ConsultaFranquicia", urlPatterns = {"/ConsultaFranquicia"})
public class ConsultaFranquicia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(nom!=null)
            {
                ...
                {
                    sql.conectar();
                    ResultSet rsUsr = sql.consulta("call sp_ConsultaFranquicia('"+nom+"');");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BajaFranquicia.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
