 ...
 * @author Alejandro
 */
@WebServlet(name = "BusquedaBajaFranquicia", urlPatterns = {"/BusquedaBajaFranquicia"})
public class BusquedaBajaFranquicia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (nom != null) {
                ...
                try {
                    sql.conectar();
                    ResultSet rsUsr = sql.consulta("call sp_ConsultaFranquicia3('" + nom + "');");
                    ...
                    while (rsUsr.next()) {
                        ...
                        out.println("<html lang=\"en\">\n"
                                ...
                                + "        <!--Formulario-->\n"
                                + "        <div class=\"container\">\n"
                                + "            <center><h3>Eliminar Franquicia</h3></center>\n"
                                + "<h3>¿Está completamente seguro de Eliminar esta Franquicia?</h3>\n"
                                ...
                                + "                    <div class=\"col-sm-10\">\n"
                                + "                        <input type=\"text\" class=\"form-control\" id=\"franchise\" name=\"franquicia\" value='" + Nombre + "' readonly required>\n"
                                + "                    </div>\n"
                                + "                </div>\n"
                                + "                <div class=\"form-group\">\n"
                                + "                        <label class=\"control-label col-sm-2\" for=\"franchiseDescription\">Descripción Franquicia</label>\n"
                                + "                    <div class=\"col-sm-10\">\n"
                                + "                        <input type=\"text\" class=\"form-control\" id=\"franchiseDescription\" name=\"descripcionFranquicia\" readonly value='" + Descrip + "' required>\n"
                                + "                    </div>\n"
                                + "                </div>\n"
                                + "                <div class=\"form-group\">        \n"
