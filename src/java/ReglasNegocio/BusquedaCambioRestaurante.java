 ...
 * @author Alejandro
 */
@WebServlet(name = "BusquedaCambioRestaurante", urlPatterns = {"/BusquedaCambioRestaurante"})
public class BusquedaCambioRestaurante extends HttpServlet {
                ...
                try {
                    ...
                    while (rsUsr.next()) {
                        ...
                        out.println("<html lang=\"en\">\n"
                                ...
                                + "        <!--Formulario-->\n"
                                + "        <div class=\"container\">\n"
                                + "            <center><h3>Cambie los datos del Restaurante</h3></center>\n"
                                + "            <hr>\n"
                                + "        </div>  \n"
                                + "        <div class=\"container\">\n"
                                ...
                                + "<button type=\"button\" onclick=\"location.href='menuFranquicia.jsp';\" class=\"btn btn-info\">Cancelar</button>\n"
                                + "                    </div>\n"
                                + "                </div>\n"
                                + "            </form>\n"
                                + "        </div>\n"
