 ...
 * @author Carmen
 */
@WebServlet(name = "BajasUsuario", urlPatterns = {"/BajasUsuario"})
public class BajasUsuario extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           String usuario = request.getParameter("correo");
            ...
            if(usuario!=null && pass !=null)
            {
                ...
                {
                    sql.conectar();
                    ResultSet rsUsr = sql.consulta("call st_BajasUsuario('"+usuario+"','"+pass+"');");
