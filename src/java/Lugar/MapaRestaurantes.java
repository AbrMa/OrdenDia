 ...
 * @author luigi
 */
@WebServlet(name = "MapaRestaurantes", urlPatterns = {"/MapaRestaurantes"})
public class MapaRestaurantes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print("<!DOCTYPE html>\n"
                    ...
                    + "            </div>\n"
                    + "        </nav>\n"
                    + "<div style='width:100%;height:500px;' id='mapa'></div>"
                    + "        </div>\n"
                    + "    </body>\n"
                    + "</html>\n"
                    + "");
    ...
    private String lugares() {
        ...
        try {
            ...
            sql.conectar();
            ResultSet r = sql.consulta("call ordenDia.ConsultaTodosLosRestaurantes;");
            int index = 0;
            while (r.next()) {
                lugares += " var point" + index + " = new google.maps.Marker({\n"
                        ...
                        + "                            '<center><h2>"+r.getString("nombre")+"</h2><br>Horarios: "+r.getString("hr_ab")+"-"+r.getString("hr_cer")+"<br>Telefono: "+r.getString("telefono")+"<br><img src=\"http://i.imgur.com/f7MJSHT.png\"\\n\\\n"
