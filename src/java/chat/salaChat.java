 ...
 * @author Alumno
 */
@WebServlet(name = "salaChat", urlPatterns = {"/salaChat"})
public class salaChat extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                out.print("<div>Hola <i class='icon-user'></i><p class='izquierda' onclick='location.href=\"sala\"'><i class='icon-keyboard-backspace'></i>Volver</p></div>");
                out.println("<input type='text' value='' placeholder='Ingresa tu Usuario' id='usuario' style='display: block'>");
                out.println("<div'><p class='tituloResumen'>Foro de Chat</p></div>");
                out.println("<div id='areaTexto'></div><br>");
                out.println("<input type='text' class='inputMensaje' id='mensaje' style='display:block'><input id='enviar'  type='button' onclick=\"mandarMensaje()\" value='Conectar'>");
                out.println("</body>");
                out.println("</html>");
            } catch (Exception e) {
