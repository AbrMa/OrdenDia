<%-- 
    Document   : BusquedaBajaFranquicia
    Created on : 03-dic-2015, 17:50:50
    Author     : Alejandro
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <form class="form-horizontal" role="form" method="post" name="BorraFranq" action="BusquedaBajaFranquicia">
