            ...
            <div class="container-fluid">
                ...
                <div>
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="menuUsuarioCliente.jsp">Regresar</a></li>
                    </ul>
                </div>
            </div>
        </nav>
                ...
                <div class="form-group">
                    <div class="col-sm-10">
                            <%
                                ...
                                try {
                                    sql.conectar();
                                    ResultSet rsUsr = sql.consulta("call sp_ConsultaPedido('"+id+"');");  

                                    while (rsUsr.next()) {
                                        String rest = rsUsr.getString("idRestaurante");
                                        String nomf = rsUsr.getString("Nombre");
                                        String Rest = rsUsr.getString("NombreRest");
                                        int tot;
                                       int cant = Integer.parseInt(rsUsr.getString("Cantidad"));
                                        ...
                                        out.print("<div class=\"form-group\">\n"
                                                        ...
                                                        + "                    <div class=\"col-sm-10\">\n"
                                                        + "                        <input type=\"text\" class=\"form-control\" id=\"franchise\" name=\"descrestaurante\" value='" + Rest + "' readonly required>\n"
                                                        + "                    </div>\n"
                                                        + "                </div>\n"
                                                        + "                <div class=\"form-group\">\n"
