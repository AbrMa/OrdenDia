...
<html lang="en">
    ...
    <body onload="recargas();">
        ...
        <!--Formulario-->
        <div class="container">
            <center><h3>Registrar Platillo</h3></center>
            <hr>
        </div>
        <div class="row">
            ...
            <div class="col-sm-5">
                ...
                <p class="lead">Comienza a registrar platillos para tus restaurantes.</p>
                
                <img class="img-responsive" src="css/food.jpg" alt="">
            ...
            <div class="col-sm-5">
                ...
                <div class="panel panel-warning">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" name="Alta" method="Post" enctype="multipart/form-data" Action="AltaPlatillo">
                <div class="panel-body">
                ...
                <div class="panel-body">
                    <label class="control-label col-sm-2" for="dish">Nombre Platillo</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="dish" maxlength="20" name="platillo" placeholder="Tacos" required>
                    </div>
                </div>
                <div class="panel-body">
                    <label class="control-label col-sm-2" for="dishDescription">Descripción Platillo</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="dishDescription" maxlength="30" name="descripcionPlatillo" placeholder="Tacos   muy Ricos" required>
                    </div>
                </div>
                <div class="panel-body">
                    <label class="control-label col-sm-2" for="price">Precio</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="price" name="precio" maxlength="5" onpaste="return false;" onkeypress="return solonumeros1(event)" placeholder="$" required>
                    </div>
                </div>
                             <div class="panel-body">        
