<%-- 
    Document   : menuRestaurante
    Created on : 03-dic-2015, 20:20:26
    Author     : Alejandro
--%>
        ...
        <div class="bannerMenuR">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a href="registrarPlatillo.jsp">
                            <center>
                                <font color="9c9b7a" size="5">
                                <i class="fa fa-coffee fa-fw fa-5x"></i> <br>
                                </font>
                                <font color="white"><b><h2>Registrar Platillo</h2></b></font>
                            </center>
                        </a>
                    </div>
                    <div class="col-sm-2">
                        <a href="BuaquedaRestauranteModificarPlatillo.jsp">
                            <center>
                                <font color="fdd393" size="5">
                                <i class="fa fa-cutlery fa-fw fa-5x"></i> <br>
                                </font>
                                <font color="white"><b><h2>Modificar Platillo</h2></b></font>
                            </center>
                        </a>
                    </div>   
                       
                    <div class="col-sm-2">
                        <a href="BusquedaBajaRestaurantePlatillo.jsp">
                            <center>
                                <font color="ff974f" size="5">
                                <i class="fa fa-trash fa-fw fa-5x"></i> <br>
                                </font>
                                <font color="white"><b><h2>Eliminar Platillo</h2></b></font>
                            </center>
                        </a>    
                    </div>
                    <div class="col-sm-2">
                        <a href="ConsultaMiRestaurante.jsp">
                            <center>
                                <font color="f54f29" size="5">
                                <i class="fa fa-glass fa-fw fa-5x"></i> <br>
                                </font>
                                <font color="white"><b><h2>Mis Restaurantes</h2></b></font>
                            </center>
                        </a>
                    </div>
                    <div class="col-sm-2"></div>
