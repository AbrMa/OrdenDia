<%-- 
    Document   : BusquedaRestauranteConsultaPedido
    Created on : 25/04/2016, 09:33:58 PM
    Author     : Alumno
--%>
...
<html lang="en">
    ...
    <body onload="recargas();">
        ...
        <div class="container">
            <form class="form-horizontal" role="form" method="post" name="BorraPlat1" action="ConsultaOrden.jsp">
