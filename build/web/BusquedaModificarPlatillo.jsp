<%-- 
    Document   : BusquedaModificarPlatillo
    Created on : 29/04/2016, 03:45:22 PM
    Author     : Alumno
--%>
    ...
    <body onload="recargas();">
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                ...
                <p class="lead">Localiza alguno de tus platillos para modificarlo.</p>

                <img class="img-responsive" src="css/platillos.jpg" alt="">

            </div>
            <div class="col-sm-5">
                <br>
                <div class="panel panel-warning">
                    <div class="panel-heading">Buscar Platillo</div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" name="BorraPlat2" action="ConsultaPlatillo.jsp">
                            <div class="panel-body">
                                <label class="control-label col-sm-2" for="franchise">Platillos del Restaurante</label>
                                <div class="col-sm-10">
                                        ...
                                        <%
                                            ...
                                            try {
                                                ...
                                                while (rsUsr.next()) {
                                                    ...
                                                    out.print("<option value=" + nomf + ">" + nomf + "</option>\n");
                                                }
