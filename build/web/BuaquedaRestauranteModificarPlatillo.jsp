<%-- 
    Document   : BuaquedaRestauranteModificarPlatillo
    Created on : 29/04/2016, 03:43:22 PM
    Author     : Alumno
--%>
    ...
    <body onload="recargas();">
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                ...
                <p class="lead">Busca un restaurante para modificar un platillo .</p>
            ...
            <div class="col-sm-5">
                ...
                <div class="panel panel-warning">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" name="BorraPlat1" action="BusquedaModificarPlatillo.jsp">
                            <div class="panel-body">
